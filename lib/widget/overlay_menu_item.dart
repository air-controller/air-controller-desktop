...
class OverlayMenuItem extends StatelessWidget {
  ...
  static const Color DEFAULT_PRESS_BACKGROUND_COLOR = const Color.fromARGB(255, 145, 201, 247);
  static const Color DEFAULT_HOVER_BACKGROUND_COLOR = const Color.fromARGB(255, 145, 201, 247);
