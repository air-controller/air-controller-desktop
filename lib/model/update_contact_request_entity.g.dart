...
part of 'update_contact_request_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UpdateContactRequestEntity _$UpdateContactRequestEntityFromJson(
        Map<String, dynamic> json) =>
    UpdateContactRequestEntity(
      id: json['id'] as int,
...
Map<String, dynamic> _$UpdateContactRequestEntityToJson(
        UpdateContactRequestEntity instance) =>
    <String, dynamic>{
      'name': instance.name,
